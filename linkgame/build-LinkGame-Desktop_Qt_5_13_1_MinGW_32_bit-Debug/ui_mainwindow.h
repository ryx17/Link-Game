...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        progressBarTimer = new QProgressBar(centralwidget);
        progressBarTimer->setObjectName(QString::fromUtf8("progressBarTimer"));
        progressBarTimer->setGeometry(QRect(250, 21, 500, 30));
        ...
        pushButtonPause->setGeometry(QRect(100, 21, 100, 30));
        pushButtonPause->setFont(font2);
        ...
        pushButtonBackToMenu->setGeometry(QRect(800, 20, 121, 30));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        progressBarTimer->setFormat(QCoreApplication::translate("MainWindow", "%p sec", nullptr));
