...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        labelBGM->setGeometry(QRect(250, 150, 71, 30));
        QFont font;
        ...
        pushButtonOn->setGeometry(QRect(450, 150, 100, 28));
        QFont font1;
        ...
        pushButtonStart->setGeometry(QRect(450, 193, 100, 30));
        QFont font2;
        ...
        pushButtonSettings->setGeometry(QRect(450, 251, 100, 30));
        ...
        pushButtonQuit->setGeometry(QRect(450, 309, 100, 30));
        ...
        pushButtonBackToMenu->setGeometry(QRect(750, 50, 121, 30));
        ...
        pushButtonMulti->setGeometry(QRect(590, 190, 100, 30));
        pushButtonMulti->setFont(font2);
        pushButtonMulti->setStyleSheet(QString::fromUtf8("QPushButton { background-color: rgb(170, 85, 0); border-radius: 3px; color: rgb(255, 255, 255); } QPushButton:hover { background-color: rgb(0, 170, 255); }"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButtonMulti->setText(QCoreApplication::translate("MainWindow", "Multigame", nullptr));
    } // retranslateUi
